...
- ☑ **AI 通道全过 + 人工通道用户已实测全过** — 待用户**明确签收**
- ⬜ **用户验收通过 / 任务 CLOSED** — 时间：______ ｜ 备注：______

> 按 workflow-spec：验收是用户的决定，AI 不能替代。请用户回复"✅ CLOSED" 或类似明示。
>
> 通过后请在 [`projects/guess-figure/README.md`](../../README.md) 「任务台账」里把 001 状态从"进行中"改为"✅ 已完成"，并 commit `stage-9: 001-guess-figure CLOSED YYYY-MM-DD`。
