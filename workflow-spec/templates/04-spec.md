...
> 详细规范见 [workflow-spec](https://github.com/znlm1229/vibe-coding-lab/blob/main/workflow-spec/specification.md#阶段-4--spec-规格人工关卡)
> 标准模板见 [`spec-template.md`](https://github.com/znlm1229/vibe-coding-lab/blob/main/workflow-spec/references/spec-template.md)
>
