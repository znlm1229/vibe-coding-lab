...
- 配套更新：[`SKILL.md`](./SKILL.md)、[`references/tooling.md`](./references/tooling.md) 同步反映；项目模板 [`first-project/workflow/_template/02-grill-me.md`](../projects/first-project/workflow/_template/02-grill-me.md) 加入调用记录槽位。
